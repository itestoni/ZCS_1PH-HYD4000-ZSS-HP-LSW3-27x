...
if (mqtt_publish > 0):
  ...
  result =  client.publish(mqtt_topic + "battery/attributes", json.dumps(dict_battery), qos=0, retain=True)
  time.sleep(1)
  result =  client.publish(mqtt_topic + "battery/state", 1, qos=0, retain=True)
  time.sleep(.1)
  result =  client.publish(mqtt_topic + "energy/attributes",  json.dumps(dict_energy), qos=0, retain=True)
  time.sleep(1)
  result =  client.publish(mqtt_topic + "energy/state", 1, qos=0, retain=True)
  time.sleep(.1)
  result =  client.publish(mqtt_topic + "on_grid_output/attributes",  json.dumps(dict_on_grid_output), qos=0, retain=True)
  time.sleep(1)
  result =  client.publish(mqtt_topic + "on_grid_output/state", 1, qos=0, retain=True)
  time.sleep(.1)
  result =  client.publish(mqtt_topic + "off_grid_output/attributes",  json.dumps(dict_off_grid_output), qos=0, retain=True)
  time.sleep(1)
  result =  client.publish(mqtt_topic + "off_grid_output/state", 1, qos=0, retain=True)
  time.sleep(.1)
  result =  client.publish(mqtt_topic + "pv_input/attributes",  json.dumps(dict_pv_input), qos=0, retain=True)
  time.sleep(1)
  result =  client.publish(mqtt_topic + "pv_input/state", 1, qos=0, retain=True)
  time.sleep(.1)
  result =  client.publish(mqtt_topic + "last_reading", mqtt_last_reading, qos=0, retain=True)
  time.sleep(.1)
